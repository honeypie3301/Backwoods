	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(7, 0)
						.addBox(3.0F, -8.0F, -4.0F, 1.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(1, 0)
						.addBox(-3.0F, -8.0F, -4.0F, 6.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(1, 0)
						.addBox(-3.0F, -1.0F, -4.0F, 6.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(7, 0).mirror()
						.addBox(-4.0F, -8.0F, -4.0F, 1.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(16, 16)
						.addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(12, 16)
						.addBox(-8.0F, 0.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(12, 16)
						.mirror().addBox(4.0F, 0.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition left_arm_r1 = left_arm_2.addOrReplaceChild("left_arm_r1",
				CubeListBuilder.create().texOffs(46, 20).mirror()
						.addBox(-0.5F, -0.5F, 0.0F, 2.0F, 20.0F, 0.0F, new CubeDeformation(0.001F)).mirror(false),
		...
		PartDefinition left_arm_r2 = left_arm_2.addOrReplaceChild("left_arm_r2",
				CubeListBuilder.create().texOffs(47, 20).mirror()
						.addBox(-1.5F, -0.5F, 0.0F, 2.0F, 20.0F, 0.0F, new CubeDeformation(0.001F)).mirror(false),
		...
		PartDefinition right_arm_r1 = right_arm_2.addOrReplaceChild("right_arm_r1",
				CubeListBuilder.create().texOffs(46, 20).addBox(-1.5F, -0.5F, 0.0F, 2.0F, 20.0F, 0.0F,
						new CubeDeformation(0.001F)),
				PartPose.offsetAndRotation(0.5F, 0.0F, 0.5F, 0.0F, -1.5708F, 0.0698F));

		PartDefinition right_arm_r2 = right_arm_2.addOrReplaceChild("right_arm_r2",
				CubeListBuilder.create().texOffs(47, 20).addBox(-0.5F, -0.5F, 0.0F, 2.0F, 20.0F, 0.0F,
						new CubeDeformation(0.001F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0698F));
