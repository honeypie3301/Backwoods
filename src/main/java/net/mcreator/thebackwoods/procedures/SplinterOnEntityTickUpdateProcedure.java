										...
										: 0) > world
												...
												.getDestroySpeed(world,
														BlockPos.containing(entityiterator instanceof SplinterEntity _datEntI ? _datEntI.getEntityData().get(SplinterEntity.DATA_mineX) : 0,
																...
																entityiterator instanceof SplinterEntity _datEntI ? _datEntI.getEntityData().get(SplinterEntity.DATA_mineZ) : 0))
												* 20 + 20) {
									if (!((entityiterator instanceof SplinterEntity _datEntI ? _datEntI.getEntityData().get(SplinterEntity.DATA_mineY) : 0) == foundPlayer.getY() - 2)) {
										if (world
												.getBlockState(BlockPos.containing(entityiterator instanceof SplinterEntity _datEntI ? _datEntI.getEntityData().get(SplinterEntity.DATA_mineX) : 0,
														entityiterator instanceof SplinterEntity _datEntI ? _datEntI.getEntityData().get(SplinterEntity.DATA_mineY) : 0,
														entityiterator instanceof SplinterEntity _datEntI ? _datEntI.getEntityData().get(SplinterEntity.DATA_mineZ) : 0))
											...
											if (!(world.getBlockFloorHeight(BlockPos.containing(
													entityiterator.level()
															.clip(new ClipContext(entityiterator.getEyePosition(1f), entityiterator.getEyePosition(1f).add(entityiterator.getViewVector(1f).scale(2)), ClipContext.Block.COLLIDER, ClipContext.Fluid.NONE,
																	entityiterator))
															.getBlockPos().getX(),
													entityiterator.getY(), entityiterator.level().clip(new ClipContext(entityiterator.getEyePosition(1f), entityiterator.getEyePosition(1f).add(entityiterator.getViewVector(1f).scale(2)),
															ClipContext.Block.COLLIDER, ClipContext.Fluid.NONE, entityiterator)).getBlockPos().getZ())) > 0)) {
												world.setBlock(BlockPos.containing(
														entityiterator.level()
																.clip(new ClipContext(entityiterator.getEyePosition(1f), entityiterator.getEyePosition(1f).add(entityiterator.getViewVector(1f).scale(2)), ClipContext.Block.COLLIDER,
